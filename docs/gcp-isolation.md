...
- In that project, enable the APIs you actually use (at minimum **Gmail**, **Calendar**, and **Tasks** for this repo’s Desktop token) so console configuration matches the OAuth scopes.
